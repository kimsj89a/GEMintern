import{u as Ue,r as l,a as d,j as e}from"./index-DesPG9lv.js";import{s as Qe,u as ae}from"./ws-DqJ9nydU.js";import{F as Se}from"./FolderTree-C5ZFkvGx.js";import{F as Ce}from"./FilePicker-BueY1jhk.js";import{C as _e}from"./ChatWidget-Dst8wOki.js";import{M as w}from"./MarkdownViewer-Dt_p-n34.js";import{c as z,d as U,g as I}from"./clipboard-D6d9SBcS.js";import{G as Ke}from"./GenerationProgress-BcuJAn27.js";import"./index-ZBjiS2o1.js";function qe(r,h){if(!r||!h||r===h)return h;const g=x=>x.split(/\n{2,}/).map(m=>m.trim()).filter(Boolean),u=g(r),S=g(h),v=x=>x.replace(/\s+/g," ").trim(),Q=new Set(u.map(v));return S.map(x=>{const m=v(x);if(Q.has(m))return x;if(/^#{1,6}\s/.test(x)){const K=v(x.replace(/^#{1,6}\s+/,""));if(u.some(le=>v(le.replace(/^#{1,6}\s+/,""))===K))return x}return`<div class="diff-highlight">
