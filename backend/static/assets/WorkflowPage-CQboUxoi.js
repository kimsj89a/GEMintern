import{u as Ue,r as l,a as d,j as e}from"./index-D5fTHYBf.js";import{s as Qe,u as ae}from"./ws-B_zT0aS1.js";import{F as Se}from"./FolderTree-UQczfHns.js";import{F as Ce}from"./FilePicker-BD9Vt43v.js";import{C as _e}from"./ChatWidget-CcHCEi_f.js";import{M as w}from"./MarkdownViewer-DOe5XHCV.js";import{c as z,d as U,g as I}from"./clipboard-B3VzIhCF.js";import{G as Ke}from"./GenerationProgress-BTo3BnQC.js";import"./index-CduAAsum.js";function qe(r,h){if(!r||!h||r===h)return h;const g=x=>x.split(/\n{2,}/).map(m=>m.trim()).filter(Boolean),u=g(r),S=g(h),v=x=>x.replace(/\s+/g," ").trim(),Q=new Set(u.map(v));return S.map(x=>{const m=v(x);if(Q.has(m))return x;if(/^#{1,6}\s/.test(x)){const K=v(x.replace(/^#{1,6}\s+/,""));if(u.some(le=>v(le.replace(/^#{1,6}\s+/,""))===K))return x}return`<div class="diff-highlight">
