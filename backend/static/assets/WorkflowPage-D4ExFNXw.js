import{u as Ue,r as l,a as d,j as e}from"./index-BqT_9_yF.js";import{s as Qe,u as ae}from"./ws-BGMfIJVA.js";import{F as Se}from"./FolderTree-BShw9N-D.js";import{F as Ce}from"./FilePicker-BxCv-25_.js";import{C as _e}from"./ChatWidget-SeicGWrO.js";import{M as w}from"./MarkdownViewer-Ckhm5pb6.js";import{c as z,d as U,g as I}from"./clipboard-XaDGIC8C.js";import{G as Ke}from"./GenerationProgress-DjlQQn5p.js";import"./index-CL62sZ_m.js";function qe(r,h){if(!r||!h||r===h)return h;const g=x=>x.split(/\n{2,}/).map(m=>m.trim()).filter(Boolean),u=g(r),S=g(h),v=x=>x.replace(/\s+/g," ").trim(),Q=new Set(u.map(v));return S.map(x=>{const m=v(x);if(Q.has(m))return x;if(/^#{1,6}\s/.test(x)){const K=v(x.replace(/^#{1,6}\s+/,""));if(u.some(le=>v(le.replace(/^#{1,6}\s+/,""))===K))return x}return`<div class="diff-highlight">
