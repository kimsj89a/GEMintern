import{u as Ue,r as l,a as d,j as e}from"./index-B30lahkL.js";import{s as Qe,u as ae}from"./ws-Bh5-M6LN.js";import{F as Se}from"./FolderTree-BySfLNjF.js";import{F as Ce}from"./FilePicker-6I7cQvQI.js";import{C as _e}from"./ChatWidget-Mp3q3hjW.js";import{M as w}from"./MarkdownViewer-B0zOd9A4.js";import{c as z,d as U,g as I}from"./clipboard-Nzpjgt5y.js";import{G as Ke}from"./GenerationProgress-BF204XzP.js";import"./index-C_Hi2xac.js";function qe(r,h){if(!r||!h||r===h)return h;const g=x=>x.split(/\n{2,}/).map(u=>u.trim()).filter(Boolean),m=g(r),S=g(h),v=x=>x.replace(/\s+/g," ").trim(),Q=new Set(m.map(v));return S.map(x=>{const u=v(x);if(Q.has(u))return x;if(/^#{1,6}\s/.test(x)){const K=v(x.replace(/^#{1,6}\s+/,""));if(m.some(le=>v(le.replace(/^#{1,6}\s+/,""))===K))return x}return`<div class="diff-highlight">
