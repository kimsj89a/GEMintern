import{u as Ue,r as l,a as d,j as e}from"./index-B-Fl-0a4.js";import{s as Qe,u as ae}from"./ws-Db5MmeWO.js";import{F as Se}from"./FolderTree-CuySe9FI.js";import{F as Ce}from"./FilePicker-DoWivP9A.js";import{C as _e}from"./ChatWidget-Cj7KjLcL.js";import{M as w}from"./MarkdownViewer-COL1nekb.js";import{c as z,d as U,g as I}from"./clipboard-BupsiYT0.js";import{G as Ke}from"./GenerationProgress-7SK8ybs7.js";import"./index-CqWYgW5S.js";function qe(r,h){if(!r||!h||r===h)return h;const g=x=>x.split(/\n{2,}/).map(u=>u.trim()).filter(Boolean),m=g(r),S=g(h),v=x=>x.replace(/\s+/g," ").trim(),Q=new Set(m.map(v));return S.map(x=>{const u=v(x);if(Q.has(u))return x;if(/^#{1,6}\s/.test(x)){const K=v(x.replace(/^#{1,6}\s+/,""));if(m.some(le=>v(le.replace(/^#{1,6}\s+/,""))===K))return x}return`<div class="diff-highlight">
