import{u as Ke,r as l,a as d,j as e}from"./index-DWmYaiV1.js";import{s as qe,u as ae}from"./ws-8PxHuhvI.js";import{F as Te}from"./FolderTree-CCfyv-Lt.js";import{F as Me}from"./FilePicker-Dmmecnlp.js";import{C as Re}from"./ChatWidget-B2xG5JUx.js";import{M as w}from"./MarkdownViewer-CS_YW9iM.js";import{c as z,d as U,g as A}from"./clipboard-TSM4FGwm.js";import{G as Je}from"./GenerationProgress-DK6IOah_.js";function Xe(r,h){if(!r||!h||r===h)return h;const g=x=>x.split(/\n{2,}/).map(u=>u.trim()).filter(Boolean),m=g(r),S=g(h),v=x=>x.replace(/\s+/g," ").trim(),Q=new Set(m.map(v));return S.map(x=>{const u=v(x);if(Q.has(u))return x;if(/^#{1,6}\s/.test(x)){const K=v(x.replace(/^#{1,6}\s+/,""));if(m.some(le=>v(le.replace(/^#{1,6}\s+/,""))===K))return x}return`<div class="diff-highlight">
