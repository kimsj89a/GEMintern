import{u as Ue,r as l,a as d,j as e}from"./index-N_5lrBOZ.js";import{s as Qe,u as ae}from"./ws-BwlpQOIx.js";import{F as Se}from"./FolderTree-D6iG7u4y.js";import{F as Ce}from"./FilePicker-DqFEwHXa.js";import{C as _e}from"./ChatWidget-bANCCNzY.js";import{M as w}from"./MarkdownViewer-B00Qytr3.js";import{c as z,d as U,g as I}from"./clipboard-DZIzGOqu.js";import{G as Ke}from"./GenerationProgress-Bp64xWVU.js";import"./index-d9B_B0nx.js";function qe(r,h){if(!r||!h||r===h)return h;const g=x=>x.split(/\n{2,}/).map(m=>m.trim()).filter(Boolean),u=g(r),S=g(h),v=x=>x.replace(/\s+/g," ").trim(),Q=new Set(u.map(v));return S.map(x=>{const m=v(x);if(Q.has(m))return x;if(/^#{1,6}\s/.test(x)){const K=v(x.replace(/^#{1,6}\s+/,""));if(u.some(le=>v(le.replace(/^#{1,6}\s+/,""))===K))return x}return`<div class="diff-highlight">
