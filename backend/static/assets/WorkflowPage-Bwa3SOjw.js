import{u as Ue,r as l,a as d,j as e}from"./index-zRYXOv50.js";import{s as Qe,u as ae}from"./ws-ocGS_YgO.js";import{F as Se}from"./FolderTree-oERZglb4.js";import{F as Ce}from"./FilePicker-BEtyOp3N.js";import{C as _e}from"./ChatWidget-NdnZ5cYL.js";import{M as w}from"./MarkdownViewer-CW8oMMip.js";import{c as z,d as U,g as I}from"./clipboard-DSP8YACP.js";import{G as Ke}from"./GenerationProgress-8G7s4YHC.js";import"./index-BKAhKbi5.js";function qe(r,h){if(!r||!h||r===h)return h;const g=x=>x.split(/\n{2,}/).map(m=>m.trim()).filter(Boolean),u=g(r),S=g(h),v=x=>x.replace(/\s+/g," ").trim(),Q=new Set(u.map(v));return S.map(x=>{const m=v(x);if(Q.has(m))return x;if(/^#{1,6}\s/.test(x)){const K=v(x.replace(/^#{1,6}\s+/,""));if(u.some(le=>v(le.replace(/^#{1,6}\s+/,""))===K))return x}return`<div class="diff-highlight">
