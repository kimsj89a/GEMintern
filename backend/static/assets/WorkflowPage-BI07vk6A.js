import{u as Ke,r as l,a as d,j as e}from"./index-Czm2Ol06.js";import{s as qe,u as ae}from"./ws-B6OWVw1w.js";import{F as Te}from"./FolderTree-BR9em1Dz.js";import{F as Me}from"./FilePicker-DHjORfuB.js";import{C as Re}from"./ChatWidget-BAEl3ryc.js";import{M as w}from"./MarkdownViewer-D1zNOvde.js";import{c as z,d as U,g as A}from"./clipboard-9M_fREOS.js";import{G as Je}from"./GenerationProgress-BbzfL7nS.js";function Xe(r,h){if(!r||!h||r===h)return h;const g=x=>x.split(/\n{2,}/).map(u=>u.trim()).filter(Boolean),m=g(r),S=g(h),v=x=>x.replace(/\s+/g," ").trim(),Q=new Set(m.map(v));return S.map(x=>{const u=v(x);if(Q.has(u))return x;if(/^#{1,6}\s/.test(x)){const K=v(x.replace(/^#{1,6}\s+/,""));if(m.some(le=>v(le.replace(/^#{1,6}\s+/,""))===K))return x}return`<div class="diff-highlight">
