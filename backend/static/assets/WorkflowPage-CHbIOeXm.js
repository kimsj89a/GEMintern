import{u as Ke,r as l,a as d,j as e}from"./index-Bb-KUamo.js";import{s as qe,u as ae}from"./ws-BYPZ-64A.js";import{F as Te}from"./FolderTree-CoO6GjZw.js";import{F as Me}from"./FilePicker-Rht6ZEgk.js";import{C as Re}from"./ChatWidget-CJ0B1cAY.js";import{M as w}from"./MarkdownViewer-vCN6cL-C.js";import{c as z,d as U,g as A}from"./clipboard-DhGGKPGj.js";import{G as Je}from"./GenerationProgress-CRnud4ZC.js";import"./index-D_AnyvBh.js";function Xe(r,h){if(!r||!h||r===h)return h;const g=x=>x.split(/\n{2,}/).map(u=>u.trim()).filter(Boolean),m=g(r),S=g(h),v=x=>x.replace(/\s+/g," ").trim(),Q=new Set(m.map(v));return S.map(x=>{const u=v(x);if(Q.has(u))return x;if(/^#{1,6}\s/.test(x)){const K=v(x.replace(/^#{1,6}\s+/,""));if(m.some(le=>v(le.replace(/^#{1,6}\s+/,""))===K))return x}return`<div class="diff-highlight">
