...
def add_master_design(slide, title_text="Gemini Investment Report"):
    ...
    # 상단 헤더 바 (Dark Blue)
    left = top = 0
    width = Inches(13.333) # 와이드스크린 너비 (16:9)
    height = Inches(0.75)
    ...
    # 헤더 텍스트 (좌측)
    textbox = slide.shapes.add_textbox(Inches(0.5), Inches(0.15), Inches(9), Inches(0.5))
    ...
    date_box = slide.shapes.add_textbox(Inches(10.5), Inches(0.15), Inches(2.5), Inches(0.5))
...
def create_title_slide(prs, title_text, subtitle_text="Generated by GEM Intern AI"):
    ...
    title.text_frame.paragraphs[0].font.color.rgb = COLOR_HEADER_BG
...
def create_content_slide(prs, title_text):
    ...
    title = slide.shapes.title
    title.text = title_text
    title.top = Inches(1.0) # 헤더 아래로 이동
...
def create_ppt(markdown_text):
    ...
    prs = Presentation()
    prs.slide_width = Inches(13.333) # 16:9 비율 설정
